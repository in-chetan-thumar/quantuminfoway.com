    ...
    <header class="site-header" id="siteHeader">
        <div class="container header-inner">
            ...
            <nav class="nav" id="mainNav" aria-label="Primary">
                    ...
                    <div class="mega-menu mega-services">
                        <div class="mega-body">
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('services/ai-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/agentic-ai'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/ai-automation'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/ai-integration'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/conversational-ai'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/claude-code-ai-for-teams'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/generative-ai'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/ai-powered-qa-testing'); ?>" class="mega-link">
                            ...
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('services/custom-software-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/enterprise-application-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/react-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/web-app-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/mobile-app-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/ui-ux-design'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/web-mobile-applications'); ?>" class="mega-link">
                            ...
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('services/no-code-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/xano-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/mvp-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/lovable-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/node-js-development'); ?>" class="mega-link">
                            ...
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('services/cloud-and-devops'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/data-analytics-and-science'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/google-workspace'); ?>" class="mega-link">
                            ...
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('services/fintech-app-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/healthcare-app-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/real-estate-app-development'); ?>" class="mega-link">
                                ...
                                <a href="<?php echo route_attr('services/travel-app-development'); ?>" class="mega-link">
                    ...
                    <div class="mega-menu mega-hire">
                        <div class="mega-body">
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('hire/xano-developer'); ?>" class="mega-link" title="Xano">
                                ...
                                <a href="<?php echo route_attr('hire/weweb-developer'); ?>" class="mega-link" title="WeWeb">
                                ...
                                <a href="<?php echo route_attr('hire/webflow-developer'); ?>" class="mega-link" title="Webflow">
                                ...
                                <a href="<?php echo route_attr('hire/bubble-developer'); ?>" class="mega-link" title="Bubble">
                                ...
                                <a href="<?php echo route_attr('hire/flutterflow-developer'); ?>" class="mega-link" title="FlutterFlow">
                                ...
                                <a href="<?php echo route_attr('hire/supabase-developer'); ?>" class="mega-link" title="Supabase">
                                ...
                                <a href="<?php echo route_attr('hire/lovable-developer'); ?>" class="mega-link" title="Lovable">
                            ...
                            <div class="mega-col mega-col-wide">
                                ...
                                <div class="mega-col-grid">
                                    <a href="<?php echo route_attr('hire/node-js-developer'); ?>" class="mega-link" title="Node.js">
                                    ...
                                    <a href="<?php echo route_attr('hire/laravel-developer'); ?>" class="mega-link" title="Laravel">
                                    ...
                                    <a href="<?php echo route_attr('hire/react-developer'); ?>" class="mega-link" title="React">
                                    ...
                                    <a href="<?php echo route_attr('hire/angular-developer'); ?>" class="mega-link" title="Angular">
                                    ...
                                    <a href="<?php echo route_attr('hire/flutter-developer'); ?>" class="mega-link" title="Flutter">
                                    ...
                                    <a href="<?php echo route_attr('hire/shopify-developer'); ?>" class="mega-link" title="Shopify">
                                    ...
                                    <a href="<?php echo route_attr('hire/wordpress-developer'); ?>" class="mega-link" title="WordPress">
                                    ...
                                    <a href="<?php echo route_attr('hire/swift-ios-developer'); ?>" class="mega-link" title="iOS">
                                    ...
                                    <a href="<?php echo route_attr('hire/kotlin-android-developer'); ?>" class="mega-link" title="Android">
                                    ...
                                    <a href="<?php echo route_attr('hire/nextjs-developer'); ?>" class="mega-link" title="Next.js">
                                    ...
                                    <a href="<?php echo route_attr('hire/python-developer'); ?>" class="mega-link" title="Python">
                                    ...
                                    <a href="<?php echo route_attr('hire/java-spring-boot-developer'); ?>" class="mega-link" title="Java">
                                    ...
                                    <a href="<?php echo route_attr('hire/full-stack-developer'); ?>" class="mega-link" title="Full Stack">
                            ...
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('hire/langchain-developer'); ?>" class="mega-link" title="LangChain">
                                ...
                                <a href="<?php echo route_attr('hire/chatgpt-developer'); ?>" class="mega-link" title="ChatGPT">
                                ...
                                <a href="<?php echo route_attr('hire/whisper-developer'); ?>" class="mega-link" title="Whisper">
                                ...
                                <a href="<?php echo route_attr('hire/ai-engineer'); ?>" class="mega-link" title="AI Engineer">
                                ...
                                <a href="<?php echo route_attr('hire/data-scientist'); ?>" class="mega-link" title="Data Science">
                                ...
                                <a href="<?php echo route_attr('hire/claude-developer'); ?>" class="mega-link" title="Claude">
                            ...
                            <div class="mega-col">
                                ...
                                <a href="<?php echo route_attr('hire/gcp-developer'); ?>" class="mega-link" title="GCP">
                                ...
                                <a href="<?php echo route_attr('hire/azure-developer'); ?>" class="mega-link" title="Azure">
                                ...
                                <a href="<?php echo route_attr('hire/aws-developer'); ?>" class="mega-link" title="AWS">
                                ...
                                <a href="<?php echo route_attr('hire/devops-engineer'); ?>" class="mega-link" title="DevOps">
                ...
                <a href="<?php echo route_attr('blogs'); ?>" class="nav-link">Blogs</a>
                <a href="<?php echo route_attr('about-us'); ?>" class="nav-link">About Us</a>
                <a href="<?php echo route_attr('contact-us'); ?>" class="btn btn-primary btn-sm nav-cta">Contact Us <span aria-hidden="true">→</span></a>
            </nav>
